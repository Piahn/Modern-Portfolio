            ...
            <form action={formAction} method='POST' className='xl:pl-10 2xl:pl-20'>
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete='name' required placeholder='Jhon Duie' className='text-field reveal-up' />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete='email' required placeholder='jhon.duie@example.com' className='text-field reveal-up' />
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder='Write your message here' required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                </div>
